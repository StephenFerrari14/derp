...
/*
Using BoX2D:?
	Create boxes of size of sprite and just stick image to box?
...
function addSquare() {
	...
	fixDef.shape.SetAsArray([
		new b2Vec2(0,0),
		new b2Vec2(0,1*sideSize),
		new b2Vec2(1*sideSize,0),
		new b2Vec2(1*sideSize,1*sideSize),
	]);
	bodyDef.position.x = width/2;
	bodyDef.position.y = height - 50;
